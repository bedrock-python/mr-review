...
description: Use for backend Python microservice work — Clean/Onion architecture, Unit of Work transactions, Outbox events, type hints, Identity/Credential services.
---
