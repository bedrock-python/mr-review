...
description: Use for meticulous backend code review — layer violations, naming conventions, type safety/Mypy, test coverage, git hygiene, datetime.utcnow() bans.
---
