---
name: backend-add-use-case
description: Implement a new application-layer Use Case — file naming, class structure, UnitOfWork dependency, transactional execute() returning Pydantic DTO.
---
