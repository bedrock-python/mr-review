---
name: frontend-add-entity
description: Add a new business entity (User, Order, Product) — folder structure, Zod schemas, API/queries/mutations, query keys, UI cards, public API.
---
