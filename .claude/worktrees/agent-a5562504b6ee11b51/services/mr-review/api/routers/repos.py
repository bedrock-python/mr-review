...
from api.schemas.mrs import DiffFileResponse, DiffHunkResponse, DiffLineResponse, MRResponse, RepoResponse

router = APIRouter(prefix="/hosts/{host_id}", tags=["repos"], route_class=DishkaRoute)
