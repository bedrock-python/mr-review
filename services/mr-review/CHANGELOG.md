...
* inbox, iterations, themes, re-dispatch, update checks, context files ([9f5ac36](https://github.com/bedrock-python/mr-review/commit/9f5ac366ec77be69ef0c0e9d8ff1862b6fe33486))
...
* **repos:** server-side search and namespace tree view for repositories ([4a628cd](https://github.com/bedrock-python/mr-review/commit/4a628cda3714f495e331f1e64dce4b8970ccbbb9))


### Bug Fixes

* **all-in-one:** serve config.js dynamically with relative API base URL ([7ad9953](https://github.com/bedrock-python/mr-review/commit/7ad9953e0ea385db63e5ce85096e0b5c08df3610))
* **cache:** add query param to CachedVCSProvider.list_repos ([3bf9ec3](https://github.com/bedrock-python/mr-review/commit/3bf9ec3cf4c280a183e48e0bb9c0684fe29f1fad))
